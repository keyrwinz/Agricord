...
import ProductDetails from 'modules/product/ProductDetailsOffline.js';
...
const ProductDetailsOfflineDrawerStack = createStackNavigator({
  MixNameScreen: {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ProductDetailsOfflineDrawerStack);